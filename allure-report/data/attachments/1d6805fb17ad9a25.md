...
Call log:
  - waiting for getByRole('checkbox', { name: 'I have read and agree to the Privacy Policy' })
...
```ts
  ...
  29  |         this.textpassword=this.page.locator('#input-password');
